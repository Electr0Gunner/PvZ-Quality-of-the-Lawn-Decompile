...
void* gResources[(int)Sexy::ResourceId::RESOURCE_ID_MAX] =
{
	...
	&Sexy::IMAGE_CHALLENGE_SLIDERSLOT,
	...
	&Sexy::IMAGE_ALMANAC_INDEXBUTTON_DISABLE,
	&Sexy::IMAGE_ALMANAC_INDEXBUTTONHIGHLIGHT_DISABLE,
	/* DelayLoad_Store */
